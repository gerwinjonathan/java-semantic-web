...
WHERE {?subject java:MemilikiStatement ?object}
END;
...
<head>
  ...
  <title>Belajar Java | Seleksi Kondisi Java</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Post Content -->
		<p class="lead">Seleksi Kondisi Java</p><hr>
		
		<?php foreach ($arr->results->bindings as $data) {
			echo $data->object->value, '<br>'; } ?>
