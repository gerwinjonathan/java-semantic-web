...
WHERE {?Programming_Language java:memilikiBahasaPemrograman ?BahasaPemrograman. ?BahasaPemrograman java:DitemukanOleh ?Penemu}
END;
...
<head>
  ...
  <title>Belajar Java | Penemu Java</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Post Content -->
		<p class="lead">Penemu Java</p><hr>
		
		<?php foreach ($arr->results->bindings as $data) {
			echo $data->Penemu->value, '<br>'; } ?>
