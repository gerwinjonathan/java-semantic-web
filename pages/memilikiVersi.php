...
SELECT ?subject ?versiJava
WHERE {?subject java:MemilikiVersi ?versiJava}
END;
...
<head>
  ...
  <title>Belajar Java | Versi Java</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Post Content -->
		<p class="lead">Versi Java</p><hr>
		
		<?php foreach ($arr->results->bindings as $data) {
			echo $data->versiJava->value, '<br>'; } ?>
